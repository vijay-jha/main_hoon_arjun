  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      margin: EdgeInsets.only(
        ...
        bottom: _deviceSize.height * 0.008,
        left: _deviceSize.width * 0.025, 
        right: _deviceSize.width * 0.025,
      ),
        ...
        child: Column(
          children: [
            ...
            InkWell(
              ...
              child: Container(
                margin: EdgeInsets.only(
                  left: _deviceSize.width * 0.035, 
                  top: _deviceSize.height * 0.005,
                  right: _deviceSize.width * 0.035, 
                  bottom: _deviceSize.height * 0.005,
                ),
                child: ShlokCard(
            ...
            Container(
              margin: EdgeInsets.only(
                left: _deviceSize.width * 0.140, 
                right: _deviceSize.width * 0.140, 
